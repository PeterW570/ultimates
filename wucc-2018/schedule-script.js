var publicSpreadsheetUrl =
  "https://docs.google.com/spreadsheets/d/1kqbddiAi-NBjZGvYhXROzzFzkB0_MKiRgM_naIgEr5E/edit?usp=sharing";
...
new Vue({
  ...
  methods: {
    parseDataForSchedule(data) {
      var parsed = {};
      data.forEach(row => {
        if (parsed[row["Day"]]) parsed[row["Day"]].push(row);
        else parsed[row["Day"]] = [row];
      });
